...
class DeclaracaoCtcAutomate:
    ...
    def __init__(self, dict_person, mouse_coordenates) -> None:
        ...
        self.coordenates_mouse_list = utils.mouse_coordenates_to_list(self.mouse_coordenates)
    ...
    def execute_substitution(self, index, frase):
        ...
        pyautogui.click(self.coordenates_mouse_list[index][0],self.coordenates_mouse_list[index][1])
        pyautogui.press("enter")
        pyautogui.tripleClick(self.coordenates_mouse_list[index][0],
                              self.coordenates_mouse_list[index][1])
        pyautogui.write(frase)

    def execute_automate(self):
        """Executa a automacao na declaracao no SEI"""
        try:
            self.dict_person["END RESID-UF"] = utils.get_uf_api(self.dict_person['END RESID-CEP'])
        ...
        pyautogui.PAUSE = 1
        pyautogui.click(self.coordenates_mouse_list[0][0],self.coordenates_mouse_list[0][1])
        frases = [
            ...
            self.dict_person["VÍNCULO SERVIDOR"][7:],
